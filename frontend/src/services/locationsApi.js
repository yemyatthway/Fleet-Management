const API_BASE_URL = import.meta.env.VITE_LOCATIONS_API_BASE_URL || 'http://localhost:5215'
...
export const getLocationCodeOptions = (params = {}) => request(`/api/locations${toQueryString(params)}`)
