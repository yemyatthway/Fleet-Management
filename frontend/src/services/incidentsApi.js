...
const API_BASE_URL = import.meta.env.VITE_INCIDENTS_API_BASE_URL || 'http://localhost:5215'
...
export const getIncidents = (params = {}) => request(`/api/incidents${toQueryString(params)}`)
