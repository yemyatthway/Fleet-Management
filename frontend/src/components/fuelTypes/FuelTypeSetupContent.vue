    ...
    <div class="page-header">
      <div>
        ...
        <p class="section-subtitle">
          Manage fuel type master data for vehicle assignment and maintenance
          workflows.
        </p>
      </div>
    </div>
    ...
    <div class="card-surface toolbar">
      <div class="toolbar-row">
        <div class="toolbar-search">
          ...
          <input
            v-model="searchQuery"
            type="text"
            placeholder="Search fuel type name, code, or description..."
          />
          <button
            v-if="searchQuery"
            class="clear-button"
      ...
      <div class="toolbar-count text-muted">
        {{
          loadingFuelTypes
            ? "Loading fuel types..."
            : `Showing ${fuelTypes.length} of ${totalFuelTypes} fuel types`
        }}
      </div>
    </div>
  ...
  openConfirm({
    ...
    action: async () => {
      ...
      try {
        ...
        showPageMessage({
          tone: "error",
          title: "Fuel type was not deleted",
          message: error.message,
        });
      }
    },
