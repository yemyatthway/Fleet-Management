    ...
    <v-card class="dialog-card">
      ...
      <form class="dialog-body" @submit.prevent="submit">
        <div class="field">
          ...
          <input v-model.trim="form.name" type="text" placeholder="Diesel" required />
        </div>

        <div class="field">
          <label class="required">Code</label>
          <input v-model.trim="form.code" type="text" placeholder="FT-DIESEL" required />
        </div>

        <div class="field">
          <label>Description</label>
          <textarea v-model.trim="form.description" rows="3" placeholder="Standard diesel fuel for commercial vehicles." />
        </div>
