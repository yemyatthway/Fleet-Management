    ...
    <main class="records-page">
      <header class="records-header">
        <div>
          <h1>Audit Logs</h1>
          <p>
            Review create, edit, delete, and status-change activity across
            modules.
          </p>
        </div>
      </header>
        ...
        <div class="table-wrap">
          ...
          >
            ...
            <template #item.roleId="{ item }">
              <span class="role-badge" :class="roleClass(item.roleId)">{{
                item.roleId
              }}</span>
            </template>
            ...
            <template #item.action="{ item }">
              <span class="role-badge" :class="actionClass(item.action)">{{
                item.action
              }}</span>
            </template>
            ...
            <template #item.newStatus="{ item }">
              <span class="role-badge" :class="statusClass(item.newStatus)">{{
                item.newStatus
              }}</span>
            </template>
