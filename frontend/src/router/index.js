...
const routes = [
  ...
  { path: '/user-code-setup/departments', component: () => import('../pages/DepartmentCodeSetup.vue') },
  { path: '/user-code-setup/locations', component: () => import('../pages/LocationCodeSetup.vue') },
  { path: '/user-code-setup/location-types', component: () => import('../pages/LocationTypeSetup.vue') },
  { path: '/user-code-setup/vehicle-types', component: () => import('../pages/VehicleTypeSetup.vue') },
  { path: '/user-code-setup/fuel-types', component: () => import('../pages/FuelTypeSetup.vue') },
